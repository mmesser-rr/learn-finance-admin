  ...
  return (
    <div className="flex flex-1 w-full items-center justify-between">
      ...
      >
        <Button
          component={Link}
          to="/pages/opportunities/new"
          className="whitespace-nowrap"
          variant="contained"
          color="secondary"
        >
          <span className="hidden sm:flex">Add New Opportunity</span>
