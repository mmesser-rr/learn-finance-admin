...
const Root = styled('div')(({ theme }) => ({
  '& .AddOpportunityPage-header': {
    background: `linear-gradient(to right, ${theme.palette.primary.dark} 0%, ${theme.palette.primary.main} 100%)`,
    color: theme.palette.primary.contrastText,
  },

  '& .AddOpportunityPage-panel': {
    margin: 0,
    border: 'none',
    '&:before': {
      display: 'none',
...
function AddOpportunityPage() {
  ...
  return (
    <Root className="w-full flex flex-col flex-auto">
      <div className="AddOpportunityPage-header flex flex-col shrink-0 items-center justify-center text-center p-16 sm:p-24 h-200 sm:h-360">
              ...
              >
                {filteredData.map((faq) => (
                  <Accordion
                    ...
                    key={faq.id}
                    classes={{
                      root: 'AddOpportunityPage-panel shadow-0',
                    }}
